...
src_util.test('Combinatorics', { tag: [ '@Courses, Textbooks and References', '@Discrete Mathematics', '@Combinatorics' ] }, async ({ page }) => {
  await page.goto(`${util.test_server}/courses-textbooks-and-references/discrete-mathematics/combinatorics`)

  const main = page.getByRole('main')

  await course_util.check_references(main, course_material.Combinatorics)

  await docs_util.check_title(main, /组合数?学/)
