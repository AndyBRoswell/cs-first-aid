...
const items = [
  {
    id: [
      ...
      { unordered_author: [ "陈纪修", "於崇华", "金路" ], title: "数学分析 第二版 上册", edition: 2, },
      { unordered_author: [ "陈纪修", "於崇华", "金路" ], title: "数学分析 第二版 上册", date: 2004, },
    ],
    material: {
      id: "陈纪修 於崇华 金路 数分2版上",
      type: "book",
  ...
  },
  {
    id: [
      ...
      { unordered_author: [ "陈纪修", "於崇华", "金路" ], title: "数学分析 第二版 下册", edition: 2, },
      { unordered_author: [ "陈纪修", "於崇华", "金路" ], title: "数学分析 第二版 下册", date: 2004, },
    ],
    material: {
      id: "陈纪修 於崇华 金路 数分2版下",
      type: "book",
  ...
  },
  {
    id: [
      ...
      { unordered_author: [ "陈纪修", "於崇华", "金路" ], title: "数学分析 第三版 上册", edition: 3, },
      { unordered_author: [ "陈纪修", "於崇华", "金路" ], title: "数学分析 第三版 上册", date: 2019, },
    ],
    material: {
      id: '陈纪修 於崇华 金路 数分上',
      type: 'book',
  ...
  },
  {
    id: [
      ...
      { unordered_author: [ "陈纪修", "於崇华", "金路" ], title: "数学分析 第三版 下册", edition: 3, },
      { unordered_author: [ "陈纪修", "於崇华", "金路" ], title: "数学分析 第三版 下册", date: 2019, },
    ],
    material: {
      id: '陈纪修 於崇华 金路 数分下',
      type: 'book',
