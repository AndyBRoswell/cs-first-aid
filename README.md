...
在这个越来越卷的时代，无数同学如履薄冰、步步为营，生怕在某个将自己导向不同世界线的关口做出错误的选择，在猛然发现走错了的时候，却已追悔莫及。
...
假如想给老机器升级，首选部件是内存或 SSD。特别是 SSD，它对用户体验的提升是非常明显的。
...
为了进一步提升生产力，可以考虑：
- 选用大屏的笔记本，不要怕重（背着当锻炼身体）。有条件的同学使用台式机亦可。但要注意配置 UPS，防止宿舍停电导致丢失数据。宿舍经常停电在内地大学并不少见。
...
不要去抢那些零碎的优惠。比如：
- 学校附近某个奶茶店开张，为了几块十来块的优惠去排队一个下午。真的很没有必要。
