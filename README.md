...
- 现在是 2023 年 11 月。⚠️**本行业的卷情进展已经极其迅速，而且仍在猛烈加速，完全没有看到任何减缓趋势**。
  - ⚠️Senior（一般不少于 5 年工作经验）受影响相对小**一些**。但 Junior（一般 0 到 2 年工作经验）以及新毕业生（new grad）的就业率早已**惨不忍睹**。即便是**顶校科班毕业+多段大厂实习（甚至还有对知名开源项目的贡献和/或高分期刊/顶会的科研成果）的也不能幸免！**
  - ⚠️中🇨🇳、美🇺🇸、加🇨🇦等 IT 岗位较多的地区已经**无一例外**出现了**非常大规模的招聘冻结（hiring freeze），并且依然在蔓延**。预计**未来相当长的时间内都不会有好转**。
  - ⚠️欧🇪🇺🇬🇧🇳🇴🇮🇸🇱🇮🇨🇭、日🇯🇵、澳🇦🇺、新🇳🇿🇸🇬、港🇭🇰等地区 IT 岗位相比中美等地相对较少，**难以承载疯狂涌入的求职者**。这些地区的就业市场亦受到经济不景气的冲击，求职难度**陡然**上升。比如荷兰🇳🇱，去年理工类找工作号称 “有手就行”（当然薪资未必好看），今年**一下子**就**全面崩盘**：**千里冰封**式招聘冻结；裁拿了**永久**合同的；越来越多不担保 Kennismigrant（KM）工作签证的；白嫖 Zoekjaar（search year）签证的；2500 欧一个月的前端岗位至少 100 多号人抢的……
- 请在确认自己具有**极大的**兴趣的条件下，再进入本专业。**编程不是一件容易的事情，而且对你的耐心提出了相当高的要求。如果你只是看重高薪🤑💰而不是发自内心热爱❤️，那么你迟早会发现自己在这条路上根本走不下去。**
  - 事实上，目前只有中🇨🇳、美🇺🇸的 IT 岗位的平均 / 中位薪资远远甩开其它行业。其它国家和地区的 IT 岗位，薪资水平不会比其它行业高出太多。随着经济下行以及本行业的各个泡沫相继破裂，许多 IT 岗位的工资大概率会**显著降低**，并且**有不低的概率降低到与大多数行业持平**。
...
- 云盘：
  ...
  - OneDrive：单人免费 5 GB。
    - 有用户反映：OneDrive 的同步机制**不是高度可靠**，导致自己的数据丢失。
      - 最近几个月以来，笔者目睹了 OneDrive 未同步重命名操作及意外删除文档各 1 次。好在有 Google Drive 的副本，否则丢失文件势必造成损失。
