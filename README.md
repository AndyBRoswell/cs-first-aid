...
- 学生签证拒签风险
  ...
  - 然而，近年来，加签🇨🇦的拒签率节节攀升。身边有同学申请加拿大学签卡在安调阶段超过一年。
...
- 以荷兰🇳🇱为例。荷兰法律规定：欧经区和瑞士🇪🇺🇮🇸🇱🇮🇳🇴🇨🇭以外的学生若需要在荷兰进行实习，需由本人、实习单位和学校共同签署三方协议（tri-party agreement）。**但实际情况多为：学校会施加各种各样的额外限制，使得非欧洲经济区且非瑞士学生在荷兰实习几乎不可能。**
