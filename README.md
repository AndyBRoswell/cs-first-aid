...
- 请在确认自己具有**极大的**兴趣的条件下，再进入本专业。**编程不是一件容易的事情，而且对你的耐心提出了相当高的要求。如果你只是看重高薪🤑💰而不是发自内心热爱❤️，那么你迟早会发现自己在这条路上根本走不下去。**
  - 事实上，目前只有中🇨🇳、美🇺🇸的 IT 岗位的平均 / 中位薪资远远甩开其它行业。其它国家和地区的 IT 岗位，薪资水平不会比其它行业高出太多。随着经济下行以及本行业的各个泡沫相继破裂，许多 IT 岗位的工资大概率会**显著降低**，并且**有不低的概率降低到与大多数行业持平**。
    - ⚠️**严重警告！**由于信息传播的滞后性，目前每年冲入计算机类专业的本科生的数量仍然是**天文数字**，并且**几何级数增长的趋势难以刹停**。**全球**的就业市场根本无法消化天量的毕业生！不要再盲目攻读计算机类专业了！按照目前的卷情，别说总体工资被冲到低于其它行业了，整个行业能否在**未来至少十几年内仅仅将现有的** Junior 大致消化完毕都是个大问题！**别问能不能勉强糊口了，直接就是要一直都一点饭都没得吃了！**
- 如你有留学和 / 或境外工作的意愿：
  ...
  - 移居境外的各种成本**绝对不低**，通常会导致你**阶级掉落**。外面不是天堂，请各位一定不要盲目。对于任何将影响自己的整个人生的决定，做之前三思总是没有错的。
