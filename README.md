...
有说法是可以大一就去实习，不过按照我的经验与观察，至少在我们这一行，许多单位不会招还在读大一的本科生进行实习。大二的话，可能有机会。当然，也鼓励在大一或大二期间就多尝试去给工作单位投简历。
...
简历一定要海投。去 N 多个网站、N 多个 APP 上投，一次总共投几百个岗位也无所谓。有的公司可能会说明只能投一个岗位。如果没有，就可以投同一个公司的多个岗位。
