...
再次提醒：可使用 [Bing Chat（Microsoft Copilot）](https://copilot.microsoft.com/)等人工智能辅助自己的学习。虽然此类人工智能在绝大多数时候都能提供正确答案，但你仍然需要结合已有知识和搜索引擎，自行判断人工智能给出的计算机相关知识的作答是否准确。
