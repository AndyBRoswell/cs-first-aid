...
- 相比之下，Bing Chat（Microsoft Copilot）能够通过搜索网络内容来增加答案的准确率。GitHub Copilot 的代码补全则使用已有代码进行训练，是高度针对本行业的人工智能。两者均能为编程和报告撰写等日常任务提供相当多的帮助。
...
### 编译原理 / Principles of Compilation
#### 课本
