...
虽然算法岗的收入往往高于开发岗和测试岗，但大厂算法岗的卷况已极其惨烈（算法的性质更偏向科研）。
...
英语的常用语法在高中应当已经学完了，后续主要是需要不断积累词汇量。从大一甚至大一入学之前就可以开始每天背单词了。
...
- 有留学意向的同学也要尽可能早地开始准备 IELTS 或 TOEFL 等考试。
  ...
  - 部分热门理工类专业会要求 GRE 成绩。GRE 对词汇量的要求明显高于 IELTS 和 TOEFL。
