...
注意：
- “信息与计算科学” 是数学类专业。
- 与 “大数据” 有关的专业，对数学的要求往往也要比软件工程之类的专业更高。
...
不玩单机游戏，三四千来块（预算宽松一点的可以放宽到五千）的机器通常也够做开发了，但是内存和硬盘的容量一定要管够。

尽量不要选带低压 U 的笔记本。除非你确实很在意轻薄、续航、发热。
...
- 多个屏幕。可以购买外接显示器，或者使用平板电脑作为第二屏。Android 系统上的免费软件 Splashtop Wired XDisplay 可以将 Android 平板电脑作为第二屏，但具有一定的 CPU 占用率。
...
## 选课时留意坑点
每学期选课时，可以找选过这门课的学长去打听，请问他们要选的课是否有坑。

举例：课堂讲授大量的过时内容，或布置许多无意义的作业。
...
我相信，以许多同学的能力，至少在本科阶段，如果积极进行自学，那么学习的速率会远远快于自己或其他人按照教学进度一点一点去学的速率。

在这里要特别强调一点，就是现在非常多的学校的计算机类专业，都会使用一个学期的时间，专门去开一门课讲某一门编程语言的基础知识。这样的速率是严重低于社会需要的。那些要求高的院校，往往都没有专门的课程去讲这些基础的东西，而只会在学期初给 1 ~ 2 周左右的时间，让学生迅速将语言的上手，掌握其基本用法。需要用到这些语言的课程在此之后再讲的，就是专业知识（比如算法）了。
