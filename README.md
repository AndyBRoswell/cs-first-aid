...
不玩单机游戏，三四千来块（预算宽松一点的可以放宽到五千）的机器通常也够做开发了。但是，内存和硬盘的容量一定要管够。

尽量不要选带低压 U 的笔记本。除非你确实十分在意轻薄、续航、发热。
...
但按照各高校和科研院所的卷况，除非天赋上特别优异，否则我不建议走科研这条路。绝大多数人更适合去搞工程。按现在的大环境，如果更多人能去工业界，既有利于减小学术界的内卷程度，减少灌水论文与专利等 “成果” 的产生，还能促进超前的科研成果尽快落地。可以说是双赢了。
...
英语的常用语法在高中基本都已经学完了，后续主要是需要不断积累词汇量。从大一甚至大一入学之前就可以开始每天背单词了。开学以后，尽快考完四六级。有留学意向的同学也要尽可能早地开始准备 IELTS 或 TOEFL 等考试。
